    ...
    <div class="form-login">
        ...
        <?php
            if (isset($_GET['error'])) {
                if($_GET['error'] == "size"){
                ?>
                    <p class="profil-p" style="color:red;">Please Upload a 320px by 240px picture</p>
                <?php
                }
                elseif($_GET['error'] == "wrongformat") {
                    ?>
                    <p class="profil-p" style="color:red;">Please Upload a image format like jpg, jpeg or png</p>
                <?php
                }
                elseif($_GET['error'] == "error") {
                    ?>
                    <p class="profil-p" style="color:red;">Something went wrong please try again later</p>
                <?php
                }
            }   
        ?>
